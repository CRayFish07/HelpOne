package com.project.rdc.onehelp.constant;

/**
 * Time:2016.11.11 11:47
 * Created By:ThatNight
 */

public class Finaldata {
    public static final String TOKEN_GET="http://api.cn.ronghub.com/user/getToken.json";
    public static final String APP_KEY="y745wfm8yooiv";
    public static final String APP_SECRECT="kSubgXPqrtgfh";
    ...
    //附近列表测试图
    public static String dogImageUrl[] = {
